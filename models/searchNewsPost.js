...
router.post('/', function(req, res){
    ...
    queryString = "SELECT DISTINCT news_title, news_id, news_link, Date_format(news_date, \"%Y-%m-%d\") as news_date FROM ttd.news WHERE news_content LIKE \'%" + inputField + "%\' ORDER BY news_id DESC ;"
