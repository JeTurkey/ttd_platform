...
router.get('/', function(req, res){
    ...
    // 今日新闻
    queryString2 = "SELECT DISTINCT news_title, news_link, gov_dept_name, Date_format(news_date, \'%y-%m-%d\') as news_date, news_id FROM ttd.gov_dept gd JOIN ttd.gov_news gn ON gn.gov_dept_id = gd.gov_dept_id JOIN ttd.news n ON n.news_id = gn.news_id WHERE gn.gov_dept_id = 1 ORDER BY n.news_id DESC LIMIT 7;"
