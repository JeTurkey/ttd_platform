...
router.get('/:id', function(req, res){
    ...
    queryString1 = 'select news_title, com_name, Date_format(news_date, \'%Y-%m-%d\') as news_date from ttd.company c join ttd.com_news cn on cn.com_id = c.com_id join ttd.news n on n.news_id = cn.news_id where cn.com_id = ' + req.params.id + ' ORDER BY cn.news_id DESC LIMIT 7;'
